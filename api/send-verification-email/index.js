...
console.log('Supabase config in send-verification:', { 
...
export default async function handler(req, res) {
  console.log('Send verification email API called, method:', req.method);
  ...
  try {
    console.log('Send verification email request body:', req.body);
